...
from islo.core.http_client import (
    AsyncHttpClient,
    HttpClient,
    _build_url,
    get_request_body,
...
from islo.core.request_options import RequestOptions
...
@patch("islo.core.http_client.time.sleep", return_value=None)
...
@pytest.mark.asyncio
@patch("islo.core.http_client.asyncio.sleep", new_callable=AsyncMock)
