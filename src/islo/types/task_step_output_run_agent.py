...
TaskStepOutputRunAgent = typing_extensions.Annotated[
    typing.Union[TaskStepOutputRunAgent_Exec, TaskStepOutputRunAgent_Session], pydantic.Field(discriminator="mode")
]
