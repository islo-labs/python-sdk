...
class ConditionalTransitionOutputParamsValue_Input(UniversalBaseModel):
...
class ConditionalTransitionOutputParamsValue_Literal(UniversalBaseModel):
...
ConditionalTransitionOutputParamsValue = typing_extensions.Annotated[
    typing.Union[
