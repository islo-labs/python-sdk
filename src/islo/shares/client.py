...
class SharesClient:
    ...
    def delete_share(
        ...
        """
        _response = self._raw_client.delete_share(sandbox_name, share_id, request_options=request_options)
        return _response.data
...
class AsyncSharesClient:
    ...
    async def delete_share(
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.delete_share(sandbox_name, share_id, request_options=request_options)
        return _response.data
