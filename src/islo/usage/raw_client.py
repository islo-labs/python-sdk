...
class RawUsageClient:
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    UsageSummary,
                    parse_obj_as(
                        type_=UsageSummary,  # type: ignore
    ...
    def get_sandbox_usage(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[typing.List[SandboxUsageDetail]]:
        """
        Parameters
        ----------
        start : typing.Optional[dt.datetime]
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.List[SandboxUsageDetail],  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawUsageClient:
    ...
    async def get_usage_summary(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UsageSummary]:
        """
        Parameters
        ----------
        start : typing.Optional[dt.datetime]
    ...
    async def get_sandbox_usage(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[typing.List[SandboxUsageDetail]]:
        """
        Parameters
        ----------
        start : typing.Optional[dt.datetime]
