...
class OAuthTokenProvider:
    ...
    def _refresh(self) -> str:
        token_response = self._auth_client.exchange_access_key(
            client_id=self._client_id, client_secret=self._client_secret
        )
        self._access_token = token_response.session_token
...
class AsyncOAuthTokenProvider:
    ...
    async def _refresh(self) -> str:
        token_response = await self._auth_client.exchange_access_key(
            client_id=self._client_id, client_secret=self._client_secret
        )
        self._access_token = token_response.session_token
        self._expires_at = self._get_expires_at(
