...
class RawWebhooksClient:
    ...
    def list_webhook_deliveries(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[typing.List[WebhookDeliverySummary]]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.List[WebhookDeliverySummary],  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    ) -> HttpResponse[WebhookDeliveryDetail]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=WebhookDeliveryDetail,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawWebhooksClient:
    ...
    async def list_webhook_deliveries(
        ...
        *,
        ...
        to: typing.Optional[dt.datetime] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[typing.List[WebhookDeliverySummary]]:
        """
        List delivery events for an incoming webhook, with optional status and date filters.
    ...
    async def get_webhook_delivery(
        self, webhook_id: str, event_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[WebhookDeliveryDetail]:
        """
        Get full detail for a single webhook delivery event, including a truncated body preview and action attempts.
